"""Utilidades compartidas por los nodos del Agente Scrum."""
...
def glossary_with_context(authoritative_context: Optional[str] = None) -> str:
    """Glosario logístico, anteponiendo el contexto autoritativo del refine (PO)."""
    glossary = glossary_block()
    if authoritative_context:
        return (
            "CONTEXTO AUTORITATIVO (respuestas del Product Owner, tienen prioridad):\n"
