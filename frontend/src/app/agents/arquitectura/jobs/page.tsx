...
/**
 * Historial del Agente arquitectura. Toda la mecánica (pestañas por estado con
  ...
  return (
    <PageContainer className="animate-rise">
      <PageHeader
        ...
        eyebrow="Diseñar"
        title="Historial"
        description="Diseños generados por el Agente Arquitectura."
        action={
          <Link
      ...
      >
        <JobsHistoryView
          ...
          fetchJobs={(limit, offset, estado) =>
            arquitecturaApi.listJobs(limit, offset, estado)
          }
